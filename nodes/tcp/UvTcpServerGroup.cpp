...
size_t UvTcpServerGroup::getNodeCount() {
  return mNodes.size();
}

UvTcpServerGroup::UvTcpServerGroup() : mImpl(make_shared<UvTcpServerImpl>()) {
...
string UvTcpServerGroup::getNodeName(size_t nodeIndex) {
  switch(nodeIndex) {
...
shared_ptr<INode> UvTcpServerGroup::getNode(const string& nodeName) {
